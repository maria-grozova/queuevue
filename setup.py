...
setup(
    name="queuevue",
    version="0.1.0",
    description=("Theme park queue data analysis using ETL and Streamlit."),
    author="Maria Grozova",
    author_email="maria.grozova@gmail.com",
    url="https://github.com/maria-grozova/queuevue",
